...
<html lang="ru">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    @vite(['resources/css/gifts.css', 'resources/js/gifts.js'])
  </head>
  <body>
    <div class="product-page">
      ...
      <header class="main-header">
        <nav class="main-nav">
          ...
          />
          <ul class="nav-links">
            <li><a href="#" class="nav-link">Изделия</a></li>
            <li><a href="#" class="nav-link">Филиалы</a></li>
            <li><a href="../Index/about us.html" class="nav-link">О нас</a></li>
          </ul>
        </nav>
        <img
      ...
      <main class="main-content">
        <h1 class="page-title">Подарки</h1>
        <p class="page-subtitle">Самое популярное на сегодняшний день</p>
        <section class="products-grid top-row">
            <article class="product-card">
              <img
                src="../img/GIFT CARD (1).png"
                alt=""
                class="product-image"
              />
              <div class="product-info">
                <h2 class="product-name">Цепочки с драг. камнями</h2>
                
              </div>
            </article>
            <article class="product-card">
              <img
                src="../img/GIFT CARD (2).png"
                alt=""
                class="product-image"
              />
              <div class="product-info">
                <h2 style="margin-left: 170px;" class="product-name">Кольца</h2>
                
              </div>
            </article> 
            <article class="product-card">
              <img
                src="../img/GIFT CARD (3).png"
                alt=""
                class="product-image"
              />
              <div class="product-info">
                <h2 style="margin-left: 170px;" class="product-name">Для него</h2>
                
              </div>
            </article>
            <article class="product-card">
              <img
                src="../img/GIFT CARD (4).png"
                alt=""
                class="product-image"
              />
              <div class="product-info">
                <h2 style="margin-left: 170px;" class="product-name">Для нее</h2>
            ...
            <article class="product-card">
              ...
              />
              <div class="product-info">
                <h2 style="margin-left: 140px;" class="product-name">Парные цепочки</h2>
            ...
            <article class="product-card">
              ...
              />
              <div class="product-info">
                <h2 style="margin-left: 170px;" class="product-name">Для них</h2>
